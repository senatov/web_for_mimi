...
const KEYWORD_PATTERN = String.raw`Google\s+Drive|Total\s+Commander|App\s+Store|MiMiNavigator|MiMiTrends|CloudStorage|Dropbox|Finder|WebDAV|⌘-Click|⇧-Click|Cmd\+Click|Shift\+Click|macOS|DMG|GPS|S3|SMB|EXIF|GitHub|SFTP|FTP|ZIP|RAR|7Z|TAR|GZIP|BZIP2|XZ|ISO|CAB|XAR|LZH|ARJ|CPIO|MP4|AVI|MKV|MOV|WEBM|FLV|WMV|MP3|WAV|FLAC|AAC|OGG|WMA|M4A|AIFF|PNG|JPEG|TIFF|BMP|WEBP|GIF|HEIC|SVG|F2|F5|F6|F7|AGPL-3\.0`;
