...
const KEYWORD_PATTERN = String.raw`SFTP|FTP|ZIP|RAR|7Z|TAR|GZIP|BZIP2|XZ|ISO|CAB|XAR|LZH|ARJ|CPIO|MP4|AVI|MKV|MOV|WEBM|FLV|WMV|MP3|WAV|FLAC|AAC|OGG|WMA|M4A|AIFF|PNG|JPEG|TIFF|BMP|WEBP|GIF|HEIC|SVG|F2|F5|F6|F7|AGPL-3\.0`;
const HIGHLIGHT_PATTERN = new RegExp(String.raw`\b(?:${VERSION_PATTERN}|${KEYWORD_PATTERN})\b`, 'gi');
const SKIPPED_SELECTOR = 'a,button,script,style,.seo-keyword-highlight';
